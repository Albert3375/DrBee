...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">@lang('panel.by_client')</li>
  </ol>
      ...
      <div class="animated fadeIn">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title mb-0"><i class="nav-icon icon-people"></i> @lang('panel.by_client') </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <h5 class="card-title mb-0">@lang('panel.by_client_all')</h5>
              </div>
