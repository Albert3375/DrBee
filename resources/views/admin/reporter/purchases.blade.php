...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">@lang('panel.clients_purchases')</li>
  </ol>
      ...
      <div class="animated fadeIn">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title mb-0"><i class="nav-icon icon-people"></i> @lang('panel.clients_purchases') </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <h5 class="card-title mb-0">@lang('panel.all_clients_purchases')</h5>
              </div>
