        ...
        <div class="card-body">
          ...
          {{-- <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" id="text-input" type="text" value="{{ $method == 'EDIT' ? $promotion->name : '' }}" name="name">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <textarea class="form-control"  style="resize: none" type="text" value="{{ $method == 'EDIT' ? $promotion->description : '' }}" name="description"  rows="5" cols="50" required>{{ $method == 'EDIT' ? $promotion->description : '' }}</textarea>
            </div>
          </div>

          <div class="form-group row">
            <label class="col-md-3 col-form-label" for="img">Imagen de la promoción @lang('panel.max') 2MB</label>
            <div class="col-md-9">
                @if(isset($promotion->image))
                    <img src="{{ URL($promotion->image) }}" style="width: auto !important; height: auto !important; max-width: 100%;">
                    <input value="{{ $promotion->image }}" class="form-control" type="file" name="image"/>
                @else
           ...
           <div class="form-group row">
            <label class="col-md-3 col-form-label" for="text-input">Vigencia</label>
            <div class="col-md-9">
              <input class="form-control" id="text-input" type="text" value="{{ $method == 'EDIT' ? $promotion->valitidy : '' }}" name="valitidy">
            </div>
          </div>
         ...
         {{--  <div class="form-group row">
            ...
            <div class="col-md-9">
              <input class="form-control" id="text-input" type="text" value="{{ $method == 'EDIT' ? $user->created_at : $date_formated }}" name="created_at" readonly>
            </div>
          </div> --}}
